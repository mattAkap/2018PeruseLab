...
public class PathTest {
	...
	public void testGetIntersection() {
		...
		intersection = new ArrayList<Point>(path.getIntersectionsPath(anotherLine)); // Normal Case, same case as
																						// polygon but only
		...
		intersection = new ArrayList<Point>(path.getIntersectionsPath(shortLine)); // Same case as polygon, but this has
																					// 3 intersections
